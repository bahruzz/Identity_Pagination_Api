...
namespace Service.Helpers
{
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<GroupTeacherEditDto, GroupTeachers>();
           

            CreateMap<GroupStudentCreateDto, GroupStudents>();
            CreateMap<GroupStudents, GroupStudentDto>();
            CreateMap<GroupStudentEditDto, GroupStudents>();
